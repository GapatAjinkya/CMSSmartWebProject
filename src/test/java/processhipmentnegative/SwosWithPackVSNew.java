...
public class SwosWithPackVSNew {

	public static WebDriver driver;
	public static WebDriverWait wait;
	private String textValue = null;
	Logger logger = LogManager.getLogger("SwosWithPackVSNew");
...
public void TestCaptureShipmentid() {
	                ...
	                if (value.contains(Custcode)) {
	                	...
	                	WebElement undoPackButton = driver.findElement(By.id("UndoButtonSGFPS"));
	                	  if (undoPackButton.isEnabled()) {
	                          ...
	                          Thread.sleep(2000);
	                          WebElement DeleteButton = driver.findElement(By.id("DeleteButtonSSL"));                            
	                          while (DeleteButton.isEnabled()) {
	                        	   Thread.sleep(2000);
	                        	  driver.findElement(By.xpath("//*[@id=\"SWOSShipmentsList\"]/tbody/tr/td[1]")).click();
	...
	public void selecshipvia() throws InterruptedException {
		 Thread.sleep(3000);
	        WebElement shipviaSearch = driver.findElement(By.xpath("//*[@id=\"card4\"]/div[2]/form/div[1]/div[3]/span")); 																						// Shipvias list
			shipviaSearch.click();
