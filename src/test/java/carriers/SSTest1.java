...
//	        serviceElement.click();
		...
		if (service.equalsIgnoreCase("HoldAtLocation")) {
...
//			logger.info("HoldAtLocation Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("NonStandardContainer")) {
...
//			logger.info("NonStandardContainer Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("AutoPOD")) {
...
//			logger.info("AutoPOD Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("Dropoff")) {
...
//			logger.info("Dropoff Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("RecipientShipAlert")) {
...
//			logger.info("RecipientShipAlert Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("HazardousMaterials")) {
...
//			logger.info("Books input given ");
		...
		} else if (service.equalsIgnoreCase("FedExInternationaControlledExport")) {
		...
		} else if (service.equalsIgnoreCase("COD")) 
		{
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("FedExShipAlert")) {
		...
		//	logger.info("Tireloss Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("FedExDeliverySignatureOptions")) {
		...
		//	logger.info("Ecod Selected");
			...
			clickRate();
			Clickship();
		} else if (service.equalsIgnoreCase("DeclaredValueThirdPartyInsurance")) {
