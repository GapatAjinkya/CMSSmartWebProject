...
public class CartonDescription {
	public static WebDriver driver;
	public static WebDriverWait wait;
	Logger logger = LogManager.getLogger("CartonDescription");
	...
	public void testBlanck() throws InterruptedException {
		Thread.sleep(5000);
			...
			EntertxtCode.clear();
			EntertxtCode.sendKeys("asdf2@%.?/asdf2@%.?/asdf2@%.?/asdf2@%.?/asdf2@%.?/");
