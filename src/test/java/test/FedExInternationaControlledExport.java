...
public class FedExInternationaControlledExport {
...
//------------------------------------------------------------------------------------------------------------------------
		 ...
		 Thread.sleep(5000);
			driver.findElement(By.id("btnSpecialServices")).click();
			 ...
			 WebElement FedExInternationaControlledExport=wait.until(ExpectedConditions.elementToBeClickable(By.id("BOX7")));
