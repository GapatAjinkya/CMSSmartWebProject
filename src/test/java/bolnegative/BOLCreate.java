...
public class BOLCreate {

	public static WebDriver driver;
	public static WebDriverWait wait;
	 Logger logger = LogManager.getLogger("BOLCreate");


	 @Test(priority = 0)
	 public void ConsigneeDataTest() throws InterruptedException {
		 OpenBOLExplorer();
		 CarriersSelect("LTLNR_WL -- LTLNR_WL");
		 Create();
	 }

	 public void TestData(String code,String Comapny,String Contact) {
		 ConsigneeData(code,Comapny,Contact);
		 ok();
	 }


 public void ConsigneeData(String code,String Comapny,String Contact) {
