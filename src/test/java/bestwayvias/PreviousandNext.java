	...
	public void check() throws InterruptedException {
	    ...
	    ok.click();
		 ...
		 String check = "Previous"; // to specify the next or previous value
			WebElement buttonNext = driver.findElement(By.xpath("//button[@id='BestWayNext']"));
			WebElement buttonPrevious = driver.findElement(By.xpath("//button[@id='BestWayPrevious']"));
